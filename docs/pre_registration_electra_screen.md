...
```text
runs/electra_180g_large/lambda_0.0/
runs/electra_180g_large/lambda_0.3/
runs/electra_180g_large/lambda_0.0/{predictions,results}/
runs/electra_180g_large/lambda_0.3/{predictions,results}/
```
