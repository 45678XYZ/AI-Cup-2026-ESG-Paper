...
- [ ] **Step 1: Add the ML-Promise primary citation**
...
- [ ] **Step 2: Correct the Chinese audit prose**
...
- [ ] **Step 3: Add the external corpus protocol**
...
- [ ] **Step 4: Declare the statistical hierarchy before Results**
...
- [ ] **Step 5: Rebuild and run section-level checks**
...
- [ ] **Step 6: Commit the protocol and citation revision**
