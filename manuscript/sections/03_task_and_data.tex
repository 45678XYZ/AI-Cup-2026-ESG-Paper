...
VeriPromise\hspace{0pt}ESG development release, which uses the PromiseEval
label inventory and parent--child logic
\cite{chen2025promiseeval}.
...
\begin{figure*}[t]
  ...
  \caption{The constrained output space and controlled decision alternatives.
  Panel (a) reduces 120 Cartesian combinations to 17 legal tuples. Panel (b)
  shows that all methods consume identical base probabilities: M0 may be
  invalid, whereas projection (M1--M3) and 17-state decoding (M4--M6) always
  emit a legal tuple.}
  \label{fig:hierarchy}
\end{figure*}
...
reports and 49 companies, and it realizes 15 of the 17 legal states
...
label-derived test statistic. Each company contributes one report.
