...
The AI CUP task uses the same four-part formulation as PromiseEval: identify an
ESG promise, determine whether it has actionable evidence, assess the clarity
of the promise--evidence pair, and assign a verification horizon
\cite{aicup2026guidelines,chen2025promiseeval}. This joint verification problem
differs from
