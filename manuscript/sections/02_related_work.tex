...
The AI CUP data continue PromiseEval's four-part formulation: identify an ESG
promise, determine whether it has actionable evidence, assess the clarity of
the promise--evidence pair, and assign a verification horizon
\cite{chen2025promiseeval}. This joint verification problem differs from
