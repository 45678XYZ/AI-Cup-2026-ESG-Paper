...
it. The evaluation protocol also moves scores more than the decision rule does:
all seven rules score $0.010$--$0.020$ higher under same-document than under
document-disjoint evaluation, with every interval excluding zero, which is
larger than the $0.0082$ that separates the rules themselves. Finally, each
