...
|---|---|---|---|
| `structural/` | RoBERTa-large | 0.3 | `docs/preregistration/pre_registration_structural_training.md` |
| `lambda_sweep/` | RoBERTa-large | 0.1 / 0.3 / 1.0 | same, §7 -- selection only, scored into no table |
| `deberta_v2_320m/` | DeBERTa-v2-320M | 0.0 and 0.3 | `docs/preregistration/pre_registration_deberta_screen.md` |
| `electra_180g_large/` | ELECTRA-large | 0.0 and 0.3 | `docs/preregistration/pre_registration_electra_screen.md` |
| `rbt_base/` | Chinese RoBERTa-base | 0.0 | `docs/preregistration/rbt_base_run.md` |
